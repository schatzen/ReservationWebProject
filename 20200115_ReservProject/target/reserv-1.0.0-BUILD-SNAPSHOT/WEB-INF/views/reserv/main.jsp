...
<!-- WOW JS -->
<script
	src="${ pageContext.request.contextPath }/resources/js/wow/wow.min.js"></script>
						...
						<div class="collapse navbar-collapse">
							<ul class="nav navbar-nav pull-right">
								...
								<c:if test="${empty member }">
									<li><a href="login_form.do?url="
										encodeURIComponent(location.href)>로그인</a></li>
								</c:if>
	...
	<footer class="text-center">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p>
						Copyright &copy; 2020 All Rights Reserved By <span>Solo
							Inc.</span>
					</p>
				</div>
			</div>
