...
public class MemberController {
	...
	// 로그인 폼
	@RequestMapping("/reserv/login_form.do")
	public String login() {
		return "reserv/login_form";
	}

	// 회원가입 폼
	@RequestMapping("/reserv/member_insert_form.do")
	...
	// 로그인
	@RequestMapping("/reserv/login.do")
	...
	// 회원가입
	@RequestMapping(value = "/reserv/member_insert.do", produces = "text/json;charset=utf-8;")
	@ResponseBody
	...
	// 아이디 중복 확인
	@RequestMapping(value = "/reserv/check_id.do", produces = "text/plain;charset=utf-8;")
	@ResponseBody
