...
$(function() {
	...
	function showHideNav() {
		if ($(window).scrollTop() > 50) {
			...
			// Show logo
			$(".navbar-brand img")
					.attr("src", "../resources/img/logo/logo.png")
		}
   ...
   $(window).on('load', function () {
	    ...
	    var map= new google.maps.Map(document.getElementById('map'), {
	        zoom: 15,
	        center: {'lat':${map_vo.map_lang}, 'lng':${map_vo.map_long} }
	        });
	    
	    var marker = new google.maps.Marker({position:{'lat':${map_vo.map_lang}, 'lng':${map_vo.map_long} }, map:map});
							...
							<div class="inner-content">
								...
								<table class="table text-center">
									<tbody>
										...
										<tr>
											<th>지점명</th>
											<td>${info_vo.info_branch }</td>
										</tr>

										<tr>
											<th>방 개수</th>
											<td>${info_vo.info_room_cnt }</td>
										</tr>

										<tr>
											<th>주소</th>
											<td>${info_vo.info_addr }</td>
										</tr>

										<tr>
											<th>사업자번호</th>
											<td>${info_vo.info_business_nr }</td>
										</tr>

										<tr>
											<th>연락처</th>
											<td>${info_vo.info_tel }</td>
										</tr>
