						...
						<div class="collapse navbar-collapse">
							<ul class="nav navbar-nav pull-right">
								...
								<c:if test="${empty member }">
									<li><a href="login_form.do" class="active">로그인</a></li>
								</c:if>
					...
					<div id="input-login">
						<div id="input-id">
							<i class="fas fa-user-alt"></i> <input type="text"
								name="member_id" id="input-id-content" placeholder="Username">
						</div>
						<div id="input-pwd">
							<i class="fas fa-lock"></i> <input type="password"
								name="member_pwd" id="input-pwd-content" placeholder="Password">
						</div>
					</div>
					...
					<div class="validation text-center">
						...
						<div id="sign-in">
							<input type="button" class="btn-general btn-sign"
								id="btn-sign-in" onclick="send(this.form); return false;"
								value="로그인">
							<!--  <a class="btn-general btn-sign" href="javascript:void()" id="btn-sign-in" onclick="send(this.form); return false;">로그인</a> -->
						</div>
						<div id="sign-up">
							<input type="button" class="btn-general btn-sign"
								id="btn-sign-up" onclick="location.href='member_insert_form.do'"
								value="회원가입">
